...
public class n02_HoaDon_CTHDGUI extends javax.swing.JFrame {

    private n02_HoaDonGUI frame;

    public n02_HoaDon_CTHDGUI(n02_HoaDonGUI frame) {
        this.frame = frame;
        initComponents();
        buttonEvents();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã HĐ", "Tên món", "Số lượng", "Đơn giá", "Thành tiền"
            }
        ) {
