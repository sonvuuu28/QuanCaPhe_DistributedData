...
public class n04_PhieuNhapGUI extends javax.swing.JPanel {
    ...
    public n04_PhieuNhapGUI(n01_TrangChuGUI frame) {
        this.frame = frame;
        initComponents();
        buttonEvents();
    }
    ...
    private void initComponents() {
        ...
        Body_Title.setText("Thông tin phiếu nhập");
        ...
        LblMaHoaDon.setText("Mã phiếu nhập");
        LblMaHoaDon.setMaximumSize(new java.awt.Dimension(100, 16));
        LblMaHoaDon.setPreferredSize(new java.awt.Dimension(84, 16));
        jPanel1.add(LblMaHoaDon);

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setPreferredSize(new java.awt.Dimension(200, 37));
        jPanel2.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEADING, 0, 4));
        ...
        LblMaHoaDon1.setPreferredSize(new java.awt.Dimension(84, 16));
        jPanel4.add(LblMaHoaDon1);

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setPreferredSize(new java.awt.Dimension(200, 37));
        jPanel5.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEADING, 0, 4));

        giaTu.setBorder(null);
        giaTu.setMaximumSize(new java.awt.Dimension(200, 25));
        giaTu.setMinimumSize(new java.awt.Dimension(200, 25));
        giaTu.setPreferredSize(new java.awt.Dimension(150, 25));
        jPanel5.add(giaTu);

        jSeparator2.setForeground(new java.awt.Color(51, 51, 51));
        jSeparator2.setPreferredSize(new java.awt.Dimension(150, 5));
        ...
        LblMaHoaDon2.setPreferredSize(new java.awt.Dimension(84, 16));
        ...
        LblMaHoaDon3.setPreferredSize(new java.awt.Dimension(84, 16));
        ...
        giaDen.setPreferredSize(new java.awt.Dimension(150, 25));
        jPanel10.add(giaDen);

        jSeparator4.setForeground(new java.awt.Color(51, 51, 51));
        jSeparator4.setPreferredSize(new java.awt.Dimension(150, 5));
        ...
        LblMaHoaDon4.setPreferredSize(new java.awt.Dimension(84, 16));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã PN", "Ngày lập", "Mã nhân viên", "Mã nhà cung cấp", "Tổng tiền"
            }
        ) {
    ...
    private void reset() {
        ...
        giaTu.setText("");
        giaDen.setText("");
        n04_PhieuNhapBUS.getInstance().listAll(table, frame.getMaCN());
    }
    ...
    private void buttonEvents() {
        ...
        PanelNhapHang.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Biggest.removeAll();
                n04_NhapHangGUI bh = new n04_NhapHangGUI(frame);
        ...
        BtnTimKiem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                n04_PhieuNhapBUS.getInstance().search(table, ma, ngayBD, ngayKT, giaTu, giaDen, frame.getMaCN());
            }
        });
        ...
        table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                n04_PhieuNhapGUI.this.setMaPN(model.getValueAt(selectedRow, 0).toString());
                n04_PhieuNhap_CTPNGUI a = new n04_PhieuNhap_CTPNGUI(n04_PhieuNhapGUI.this);
                a.setVisible(true);
