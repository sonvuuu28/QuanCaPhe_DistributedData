...
public class n09_KhuyenMaiGUI extends javax.swing.JPanel {

    public n09_KhuyenMaiGUI() {
        initComponents();
        buttonEvents();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã", "Tên", "Ngày bắt đầu", "Ngày kết thúc", "Phần trăm", "Chi tiêu", "Hiệu lực"
            }
        ) {
                ...
                .addGroup(PanelInputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PanelInputLayout.createSequentialGroup()
                        ...
                        .addGroup(PanelInputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ma, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)))
                    .addGroup(PanelInputLayout.createSequentialGroup()
        ...
        BiggestLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BiggestLayout.createSequentialGroup()
                ...
                .addGroup(BiggestLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(scrollPaneTable, javax.swing.GroupLayout.PREFERRED_SIZE, 774, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35))
        );
    ...
    private void reset() {
        ...
        chiTieu.setText("");
        TimKiem.setText("Tìm kiếm nhanh theo tên");
        n09_KhuyenMaiBUS.getInstance().listAll(table, false);
    ...
    private void buttonEvents() {
        ...
        PanelUuDai.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Biggest.removeAll();
                n09_UuDaiGUI bh = new n09_UuDaiGUI();
        ...
        TimKiem.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
                    n09_KhuyenMaiBUS.getInstance().searchByName(table, TimKiem.getText(), false);
                }
            }
        });
        ...
        BtnTimKiem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                n09_KhuyenMaiBUS.getInstance().search(table, ma.getText(), ten.getText(), phanTramTryCatch, ngayBatDauTryCatch,
                        ngayKetThucTryCatch, chiTieuTryCatch, false);
            }
        });
        ...
        BtnThem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (n09_KhuyenMaiBUS.getInstance().checkInput(ma, ten, phanTram, NgayBatDau, NgayKetThuc, chiTieu) == true) {
                    int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn thêm khuyến mãi không?", "Xác nhận", JOptionPane.YES_NO_OPTION);
        ...
        BtnSua.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (ma.getText().equals(n09_KhuyenMaiBUS.getInstance().createID())) {
                    JOptionPane.showMessageDialog(null, "Vui lòng chọn 1 khuyến mãi trong danh sách để sửa!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    if (n09_KhuyenMaiBUS.getInstance().checkInput(ma, ten, phanTram, NgayBatDau, NgayKetThuc, chiTieu) == true) {
                        int response = JOptionPane.showConfirmDialog(null, "Bạn có muốn sửa thông tin khuyến mãi không?", "Xác nhận", JOptionPane.YES_NO_OPTION);
