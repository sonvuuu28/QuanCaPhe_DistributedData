...
public class n02_HoaDonDAO {
    ...
    public boolean insert(HoaDonDTO hd) {
        ...
        String sqlInsert = "INSERT INTO HoaDon(MaHoaDon, NgayLapHoaDon, TongTienHoaDon, MaNhanVien, MaKhachHang, MaKhuyenMai, MaKhuyenMaiMember, MaChiNhanh) "
                + " VALUES(?, ?, ?, ?, ?, ?, ?, ?) ";
        String sqlUpdate = " UPDATE KhachHang SET ChiTieu = ChiTieu + ? WHERE MaKhachHang = ? ";
    ...
    public boolean insertChiTietHoaDon(ArrayList<ChiTietHoaDonDTO> dsChiTiet) {
        boolean result = false;
        String sql = "INSERT INTO ChiTietHoaDon(MaHoaDon, MaMon, DonGia, SoLuong, ThanhTien) VALUES (?, ?, ?, ?, ?)";
    ...
    public ArrayList<HoaDonDTO> listAll(String ma) {
    ...
    public ArrayList<HoaDonDTO> search(String ma, Date ngayBD, Date ngayKT, Long giaTu, Long giaDen, String maCN) {
        ...
        StringBuilder sql = new StringBuilder("select * from HoaDon where MaChiNhanh = ?");
        params.add(maCN);
